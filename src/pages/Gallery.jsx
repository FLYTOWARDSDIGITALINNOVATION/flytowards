            ...
            <section className="hero" style={{ minHeight: '60vh', display: 'flex', alignItems: 'center', paddingTop: '140px' }}>
                <div style={{ textAlign: 'center', maxWidth: '900px', margin: '0 auto' }} data-aos="fade-up">
                    ...
                    <div data-aos="zoom-in" style={{ width: '100%', height: '400px', borderRadius: '30px', overflow: 'hidden', boxShadow: '0 20px 40px rgba(0,0,0,0.2)', border: '4px solid white' }}>
                        <img src="./gallary.webp" alt="Fly Towards Team" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                    </div>
                </div>
            </section>
                                ...
                                style={{
                                    ...
                                    background:
                                        event.title === 'Tech Innovators Meetup'
                                            ? '#FFF1F2'
                                            : event.title === 'Digital Marketing Summit 2026'
                                                ? '#EFF6FF'
                                                : event.title === 'WhatsApp Marketing Masterclass'
                                                    ? '#F5F3FF'
                                                    : undefined,
                                    borderLeft: `4px solid ${idx % 3 === 0 ? 'var(--neon-cyan)' : idx % 3 === 1 ? 'var(--neon-pink)' : 'var(--neon-purple)'}`,
                                    transitionDelay: `${0.1 * (idx + 1)}s`,
                                }}
                            >
