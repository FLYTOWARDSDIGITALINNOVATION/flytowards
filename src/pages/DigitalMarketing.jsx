        ...
        <main>
                            ...
                            style={(() => {
                                ...
                                return {
                                    ...
                                    ...((isDataDriven || isMultiChannel)
                                        ? {
                                            backgroundImage: `linear-gradient(rgba(15, 23, 42, 0.88), rgba(15, 23, 42, 0.88)), url("${encodeURI(isDataDriven ? '/Data-Driven Strategies.jpg' : '/Multi-Channel Dominance.jpg')}")`,
            ...
            <section id="contact">
                <div className="cta-content" data-aos="zoom-in" style={{
                    backgroundImage: `url("${encodeURI('/service market.png')}")`,
                    backgroundSize: 'cover',
                    backgroundPosition: 'center',
