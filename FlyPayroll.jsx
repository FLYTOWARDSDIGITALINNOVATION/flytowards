                ...
                <div className="grid max-w-1200" style={{ margin: '0 auto', gap: '2.5rem', alignItems: 'stretch' }}>
                    {workflows.map((workflow, idx) => {
                        const themeVars = idx === 0
                            ? {
                                '--workflow-card-bg': 'linear-gradient(135deg, #ff007a 0%, #2563eb 100%)',
                                '--workflow-card-border': 'rgba(255, 255, 255, 0.25)',
                                '--workflow-heading-color': 'rgba(255, 255, 255, 0.95)',
                                '--workflow-step-bg': 'rgba(255, 255, 255, 0.88)',
                                '--workflow-step-border': 'rgba(255, 255, 255, 0.35)',
                                '--workflow-step-text': 'rgba(15, 23, 42, 0.95)',
                                '--workflow-number-bg': 'linear-gradient(135deg, #2563eb 0%, #ff007a 100%)',
                                '--workflow-number-color': '#ffffff'
                            }
                            : {
                                '--workflow-card-bg': 'linear-gradient(135deg, #e9d5ff 0%, #ffffff 100%)',
                                '--workflow-card-border': 'rgba(15, 23, 42, 0.08)',
                                '--workflow-heading-color': 'var(--text-dark)',
                                '--workflow-step-bg': 'rgba(255, 255, 255, 0.92)',
                                '--workflow-step-border': 'rgba(15, 23, 42, 0.10)',
                                '--workflow-step-text': 'var(--text-dark)',
                                '--workflow-number-bg': 'linear-gradient(135deg, #c084fc 0%, #ffffff 100%)',
                                '--workflow-number-color': '#4c1d95'
                            };
